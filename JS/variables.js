...
console.log(str2.indexOf('r'));//-1

const str3='hola';
console.log(str3.substring(1,3));//ol
console.log(str3.substring(1));//ola
...
console.log(str4.charAt(4)); //undefined porque no existe posición 4 con letra
...
daysoftheweek.length=4;//hasta el jueves
console.log(daysoftheweek)//console para que se ejecute
...
console.log(month) //mes de mayo (5) ME SALE NUMERO 4 PREGUNTAR PORQUE
